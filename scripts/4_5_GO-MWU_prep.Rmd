...
geneIDs_foldchange(input_file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low2_indiv/AllGenes_wcols.txt",
              blast_file = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
              output_file = "../scripts/4_6_running_GO-MWU/cbai4.0_low0_vs_low2_indiv_l2FC.csv")

# Lowered Day 0 vs. Lowered Day 2 + 17
geneIDs_foldchange(input_file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low217_indiv/AllGenes_wcols.txt",
              blast_file = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
              output_file = "../scripts/4_6_running_GO-MWU/cbai4.0_low0_vs_low217_indiv_l2FC.csv")

# Lowered Day 0 + Ambient Day 0 + 2 + 17 vs. Lowered Day 2 + 17
geneIDs_foldchange(input_file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_amb0217_vs_low217_indiv/AllGenes_wcols.txt",
              blast_file = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
              output_file = "../scripts/4_6_running_GO-MWU/cbai4.0_low0_amb0217_vs_low217_indiv_l2FC.csv")

# Lowered Day 2 + 17 vs. Ambient Day 2+17
geneIDs_foldchange(input_file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low217_vs_amb217_indiv/AllGenes_wcols.txt",
              blast_file = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
              output_file = "../scripts/4_6_running_GO-MWU/cbai4.0_low217_vs_amb217_indiv_l2FC.csv")
...
geneIDs_foldchange(input_file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_amb0_vs_low17_amb17_indiv/AllGenes_wcols.txt",
              blast_file = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
              output_file = "../scripts/4_6_running_GO-MWU/cbai4.0_low0_amb0_vs_low17_amb17_indiv_l2FC.csv")

# Lowered Day 0 + Elevated Day 0 vs. Lowered Day 2 + Elevated Day 2
geneIDs_foldchange(input_file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_elev0_vs_low2_elev2_indiv/AllGenes_wcols.txt",
              blast_file = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
              output_file = "../scripts/4_6_running_GO-MWU/cbai4.0_low0_elev0_vs_low2_elev2_indiv_l2FC.csv")
```