...
Typically, we would choose the lowest power below 30 that reached an R2 value of 0.8 or higher. This means we will choose 12 as our level for all comparisons
