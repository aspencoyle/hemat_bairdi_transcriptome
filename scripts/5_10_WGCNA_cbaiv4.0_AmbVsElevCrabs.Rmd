...
crabClinicalData <- data.frame("crab" = c(rep(c(1, 2, 3, 4, 5, 6), times = 2), 1, 2, 3),
                         "day" = c(rep(0, times = 6),
                                   rep(2, times = 6),
                                   rep(17, times = 3)),
                         "temp" = c(rep(c(1, 1, 1, 2, 2, 2), times = 2), rep(2, times = 3)))
...
file_start <- "../output/WGCNA_output/cbai_transcriptome_v4.0/amb_vs_elev_no_filter/"
...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. Here, that means we will choose a soft-thresholding power of 12!
