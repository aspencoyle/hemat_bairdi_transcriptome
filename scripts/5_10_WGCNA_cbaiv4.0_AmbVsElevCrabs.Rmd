...
file_start <- paste0("../output/WGCNA_output/cbai_transcriptomev4.0/amb_vs_elev_no_filter/", variable, "_as_var/")
...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. This means we will choose the following:

- 9: CW
- 13: Day, Temp, hemat_level
