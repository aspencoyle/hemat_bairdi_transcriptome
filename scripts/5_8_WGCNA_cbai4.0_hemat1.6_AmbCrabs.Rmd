...
The two transcriptomes used to create the libraries are cbai_transcriptomev4.0 and hemat_transcriptomev1.6
...
All kallisto libraries should be available within the GitHub repo. However, one datafile - our blastx table, cbai4.0_hemat1.6_transcriptomes_blastx_table.txt. This is two BLASTx annotations - of hemat_transcriptomev1.6.fasta and cbai_transcriptomev4.0.fasta - appended to each other. 
...
**Description of hemat_transcriptomev1.6.fasta and BLASTx annotation**
