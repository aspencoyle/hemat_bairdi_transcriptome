...
file_start <- paste0("../output/WGCNA_output/cbai_transcriptomev2.0/amb_vs_elev_no_filter/", variable, "_as_var/")
...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. That means we will choose 11 as the power for day, temp, hemat_level, and CW alike
