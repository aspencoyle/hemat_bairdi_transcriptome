---
title: "5_2_WGCNA_cbai4.0_AllCrabs"
author: "Aspen Coyle"
...
|---------|-----------------|-----------------|-----------------|------------------|
| A       | control         | 178             | 359             | 463              |
| B       | control         | 118             | 349             | 481              |
| C       | control         | 132             | 334             | 485              |
...
crabTraits <- data.frame("crab" = binarizeCategoricalVariable(x = c(rep(c("A", "B", "C", "D", "E", "F", "G", "H", "I"), times = 2), 
                         ...
                         "day" = factor(c(rep(0, times = 9),
                                          rep(2, times = 9),
                                          rep(17, times = 6))),
                         "temp" = binarizeCategoricalVariable(x = c(rep("control", times = 12),
                                    rep("Lowered", times = 3),
...
file_start <- paste0("../output/WGCNA_output/cbai_transcriptomev4.0/all_crabs/", variable, "_as_var/")
...
labeledHeatmap(Matrix = moduleTraitCor,
               xLabels = c("Crab C1",
                           ...
                           "Shell Condition"),
               xLabelsAngle = 45,
               yLabels = c("Red (n = 128)", "Black (n = 117)", "Blue (n = 5741)", "Pink (n = 106)", "Brown (n = 1903)", "Yellow (n = 1890)"),
