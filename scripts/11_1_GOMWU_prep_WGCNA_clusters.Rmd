...
| Unfiltered    | All        | **Temp (Low v Amb)**| **tan**     | 0.05    | Y                        |                                                |
...
| Host          | All        | **Temp (Low v Amb)**| **red**     | 0.01    | N (Crab C, 2x10^-8)      | hemat_level, CW                                |
...
| Parasite      | All        | **Temp (Low v Amb)**|**turquoise**| 0.02    | N (Crab C, 4x10^-6)      | hemat_level, CW                                |
...
**Unfiltered, All**
- Tan (Low vs. Amb, hemat_level)

**Host, All**
- Red (Low vs Amb)

**Parasite, All**
- Turquoise ( Low vs Amb, hemat_level)
...
WGCNA_modules_accessions_kMEs(module_name = "turquoise",
                              transcriptome = "hemat_transcriptomev1.6",
                              compar = "all_crabs_no_filter",
                              blast_path = "../data/hemat_blastx_table_transcriptome_v1.6.txt",
                              output_GOMWU = "../scripts/11_4_running_GOMWU/",
