...
clusts <- list(c("HTL", "HTL2", "LTH", "LTH2", "LTH3", "HTL2", "HLH"),     # Crab A          
               c("LTH", "LHL", "LTH2", "HTL", "HLH", "LHL2", "HTL2"),  # Crab B
               c("HTL", "HTL2", "LTH", "HLH", "HTL3", "LTH2", "LHL"),  # Crab C
               c("LTH", "LHL", "HLH", "LTH2", "LHL2", "HTL"),  # Crab D
               c("LHL", "LTH", "HTL", "LTH2", "LTH3", "HTL2"),  # Crab E
               c("LTH", "HTL", "LHL", "LHL2", "HTL2", "LTH2"),  # Crab F
               c("LH", "LH2", "HL", "HL2", "HH", "LL", "HL3", "LH3"),  # Crab G
               c("LL", "HH", "HL", "HH2", "LH"),  # Crab H
               c("LL", "LL2", "LH", "HL", "HL2"))  # Crab I
