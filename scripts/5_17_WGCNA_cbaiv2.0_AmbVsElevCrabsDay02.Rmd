---
title: "5_17_WGCNA_cbaiv2.0_AmbVsElevCrabs_Day02"
author: "Aidan Coyle"
...
We will now run WGCNA on all individual libraries of ambient and elevated-temperature crabs over days 0 and 2 ONLY

This will be ran on libraries aligned to cbai_transcriptomev2.0, which is unfiltered by taxonomy
...
libraries <- c("178", "118", "132", "173", "072", "127", "359", "349", "334", "272", "294", "280")
...
crabTraits <- data.frame("crab" = rep(c("A", "B", "C", "G", "H", "I"), times = 2),
...
# If treating elevated day 0 as elevated
crabClinicalData <- data.frame("crab" = rep(c(1, 2, 3, 4, 5, 6), times = 2),
                         "day" = c(rep(0, times = 6),
                                   rep(2, times = 6)),
                         "temp" = c(rep(c(1, 1, 1, 2, 2, 2), times = 2)))
...
file_start <- "../output/WGCNA_output/cbai_transcriptomev2.0/amb_vs_elev_days_02/day0_elev_as_amb/"
...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. Therefore, we will choose 7!
