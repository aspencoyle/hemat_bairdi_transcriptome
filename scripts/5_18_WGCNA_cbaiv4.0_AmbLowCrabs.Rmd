---
title: "5_18_WGCNA_cbai4.0_AmbLowCrabs"
author: "Aidan Coyle"
...
This will be ran on libraries aligned to cbai_transcriptomev4.0, which includes only genes that are presumably _Chionoecetes_. 
...
All kallisto libraries should be available within the GitHub repo. However, one datafile - our blastx table, cbai_diamond_blastx_table_transcriptomev4.0.txt,is not. This is a BLASTx annotation of cbai_transcriptomev4.0.fasta.
...
file_start <- paste0("../output/WGCNA_output/cbai_transcriptomev4.0/amb_low/", variable, "_as_var/")
...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. However, that threshold was not reached . Therefore, we will follow the instructions of the [WGCNA FAQ](https://horvath.genetics.ucla.edu/html/CoexpressionNetwork/Rpackages/WGCNA/faq.html), which recommends a soft-thresholding power of 18 for unsigned networks with under 20 samples.
