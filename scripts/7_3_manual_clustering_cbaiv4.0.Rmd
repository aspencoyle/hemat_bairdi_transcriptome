...
heatmap_output <- "../output/manual_clustering/cbai_transcriptomev4.0/all_genes/"
...
clusts <- list(c("LHL", "HTL", "LHL2", "LTH", "LTH2", "HTL2", "HLH"),  # Crab A          
               c("LTH", "HTL", "LHL", "HTL2", "LTH2", "HLH"),  # Crab B
               c("HLH", "LHL", "LTH", "HTL", "HTL2", "LTH2", "LHL2"),  # Crab C
               c("LTH", "LHL", "HLH", "LTH2", "HTL", "LTH3", "HTL2", "HTL3"),  # Crab D
               c("LHL", "LTH", "HTL", "LHL2", "LTH2", "HLH", "HTL2"),  # Crab E
               c("LTH", "HTL", "LHL", "LHL2", "HTL2", "HLH", "LTH2"),  # Crab F
               c("LH", "LH2", "MIX", "MIX2", "MIX3", "HL", "HL2"),  # Crab G
               c("MIX", "MIX2", "MIX3", "MIX4", "LH"),  # Crab H
               c("MIX", "MIX2", "LH", "MIX3", "HL", "MIX4"))  # Crab I
