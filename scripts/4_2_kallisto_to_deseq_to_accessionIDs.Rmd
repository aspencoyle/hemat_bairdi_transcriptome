...
exp_design <- data.frame(day = factor(c(2, 2, 2, 
                                        17, 17, 17)))
deseq_analysis(kallisto_path = "../output/kallisto_matrices/cbai_transcriptomev4.0/amb2_vs_amb17_indiv/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
...
deseq_analysis(kallisto_path = "../output/kallisto_matrices/cbai_transcriptomev4.0/all_indiv_libraries/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/temp_as_var/",
               variable = "temp")
```
...
deseq_analysis(kallisto_path = "../output/kallisto_matrices/cbai_transcriptomev4.0/all_indiv_libraries/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/crab_as_var/",
               variable = "crab")
```
...
deseq_analysis(kallisto_path = "../output/kallisto_matrices/cbai_transcriptomev4.0/all_indiv_libraries/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/day_as_var/",
               variable = "day")
```
...
deseq_analysis(kallisto_path = "../output/kallisto_matrices/cbai_transcriptomev4.0/all_indiv_libraries/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/infection_as_var/",
               variable = "infection")
```
...
deseq_analysis(kallisto_path = "../output/kallisto_matrices/cbai_transcriptomev4.0/all_indiv_libraries/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/hemat_level_as_var/",
...
# Read in data
data <- read.table("../output/kallisto_matrices/cbai_transcriptomev4.0/all_indiv_libraries/kallisto.isoform.counts.matrix", header = TRUE, sep = "\t")
...
write.table(means, file = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/PCA_plasticity.txt", row.names = FALSE)
```
...
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low2_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_vs_low2_indiv_DEG_IDs.txt")

# Lowered Day 0 vs. Lowered Day 2 + 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low217_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_vs_low217_indiv_DEG_IDs.txt")

# Lowered Day 0 + Ambient Day 0 + 2 + 17 vs. Lowered Day 2 + 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_amb0217_vs_low217_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_amb0217_vs_low217_indiv_DEG_IDs.txt")

# Lowered Day 2 + 17 vs. Ambient Day 2+17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low217_vs_amb217_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low217_vs_amb217_indiv_DEG_IDs.txt")

# Lowered Day 0 vs. Ambient Day 0
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_amb0_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_vs_amb0_indiv_DEG_IDs.txt")

# Lowered Day 0 vs. Lowered Day 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low17_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_vs_low17_indiv_DEG_IDs.txt")

# Lowered Day 0 + Ambient Day 0 vs. Lowered Day 17 + Ambient Day 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_amb0_vs_low17_amb17_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_amb0_vs_low17_amb17_indiv_DEG_IDs.txt")

# Lowered Day 0 + Elevated Day 0 vs. Lowered Day 2 + Elevated Day 2
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_elev0_vs_low2_elev2_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/DEG_IDs/low0_elev0_vs_low2_elev2_indiv_DEG_IDs.txt")
```
...
# All Genes
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/all_indiv_libraries/crab_as_var/AllGenes_wcols.txt", 
                       blast_filepath =  "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/all_indiv_libraries_All_GeneIDs.txt")

# Lowered Day 0 vs. Lowered Day 2
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low2_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_vs_low2_indiv_All_GeneIDs.txt")

# Lowered Day 0 vs. Lowered Day 2 + 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low217_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_vs_low217_indiv_All_GeneIDs.txt")

# Lowered Day 0 + Ambient Day 0 + 2 + 17 vs. Lowered Day 2 + 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_amb0217_vs_low217_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_amb0217_vs_low217_indiv_All_GeneIDs.txt")

# Lowered Day 0 vs. Ambient Day 0
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_amb0_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_vs_amb0_indiv_All_GeneIDs.txt")

# Lowered Day 0 vs. Lowered Day 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_vs_low17_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_vs_low17_indiv_All_GeneIDs.txt")

# Lowered Day 2 + 17 vs. Ambient Day 2+17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low217_vs_amb217_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low217_vs_amb217_indiv_All_GeneIDs.txt")

# Lowered Day 0 + Ambient Day 0 vs. Lowered Day 17 + Ambient Day 0
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_amb0_vs_low17_amb17_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_amb0_vs_low17_amb17_indiv_All_GeneIDs.txt")


# Lowered Day 0 + Elevated Day 0 vs. Lowered Day 2 + Elevated Day 2
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/cbai_transcriptomev4.0/low0_elev0_vs_low2_elev2_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/cbai4.0_blastxres.tab",
                       output_path = "../output/accession_n_GOids/cbai_transcriptomev4.0/allgenes_IDs/low0_elev0_vs_low2_elev2_indiv_All_GeneIDs.txt")
