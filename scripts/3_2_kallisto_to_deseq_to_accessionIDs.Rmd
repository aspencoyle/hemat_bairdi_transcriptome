...
kallisto_path <- "../output/kallisto_matrices/hemat_transcriptomev1.6/low0_vs_low17_indiv/kallisto.isoform.counts.matrix"
experiment_table <-  exp_design
output_path <- "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_vs_low17_indiv"
variable <- "Day"
...
deseq_analysis(kallisto_path = "../output/kallisto_matrices/hemat_transcriptomev1.6/low0_amb0_vs_low17_amb17_indiv/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_amb0_vs_low17_amb17_indiv",
               variable = "Day")
```
...
exp_design <- data.frame(day = factor(c(2, 2, 2, 
                                        17, 17, 17)))
deseq_analysis(kallisto_path = "../output/kallisto_matrices/hemat_transcriptomev1.6/amb2_vs_amb17_indiv/kallisto.isoform.counts.matrix",
               experiment_table = exp_design,
               output_path = "../graphs/DESeq2_output/hemat_transcriptomev1.6/amb2_vs_amb17_indiv",
               variable = "day")
```
...
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/amb2_vs_amb17_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/DEG_IDs/amb2_vs_amb17_indiv_DEG_IDs.txt")
...
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_vs_low17_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/DEG_IDs/low0_vs_low17_indiv_DEG_IDs.txt")

# Lowered Day 0 + Ambient Day 0 vs. Lowered Day 17 + Ambient Day 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_amb0_vs_low17_amb17_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/DEG_IDs/low0_amb0_vs_low17_amb17_indiv_DEG_IDs.txt")

# Lowered Day 0 + Elevated Day 0 vs. Lowered Day 2 + Elevated Day 2
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_elev0_vs_low2_elev2_indiv/DEGlist_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/DEG_IDs/low0_elev0_vs_low2_elev2_indiv_DEG_IDs.txt")
...
# Lowered Day 0 vs. Lowered Day 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_vs_low17_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/allgenes_IDs/low0_vs_low17_indiv_All_GeneIDs.txt")

# Lowered Day 0 + Ambient Day 0 vs. Lowered Day 17 + Ambient Day 0
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_amb0_vs_low17_amb17_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/allgenes_IDs/low0_amb0_vs_low17_amb17_indiv_All_GeneIDs.txt")

# Lowered Day 0 + Elevated Day 0 vs. Lowered Day 2 + Elevated Day 2
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/low0_elev0_vs_low2_elev2_indiv/AllGenes_wcols.txt", 
                       blast_filepath = "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/allgenes_IDs/low0_elev0_vs_low2_elev2_indiv_All_GeneIDs.txt")

# Ambient Day 2 vs. Ambient Day 17
transcripts_to_geneIDs(deseq_filepath = "../graphs/DESeq2_output/hemat_transcriptomev1.6/amb2_vs_amb17_indiv/AllGenes_wcols.txt", 
                       blast_filepath =  "../output/BLASTs/uniprot_swissprot/hemat1.6_blastxres.tab",
                       output_path = "../output/accession_n_GOids/hemat_transcriptomev1.6/allgenes_IDs/amb2_vs_amb17_indiv_All_GeneIDs.txt")
