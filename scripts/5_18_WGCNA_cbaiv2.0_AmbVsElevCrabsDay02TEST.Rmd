---
title: "5_16_WGCNA_cbaiv4.0_AmbVsElevCrabs_Day02"
author: "Aidan Coyle"
...
crabTraits <- data.frame("day" = factor(c(rep(0, times = 6),
                                   rep(2, times = 6))),
...
# If treating elevated day 0 as elevated
crabClinicalData <- data.frame("day" = c(rep(0, times = 6),
                                   rep(2, times = 6)),
...
file_start <- "../output/WGCNA_output/cbai_transcriptomev2.0/amb_vs_elev_days_02/test/"
