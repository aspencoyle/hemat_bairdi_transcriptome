...
# Select a variable to show in your PCA. Should be one of the above in exp_design
var_name <- "infection"
...
We can re-run the above chunk multiple times but with var_name changed to highlight different variables. The chunk below will find the plasticity of each crab by taking the mean distance from each point to the centroid of the PCA, and thus only needs to be run once.
