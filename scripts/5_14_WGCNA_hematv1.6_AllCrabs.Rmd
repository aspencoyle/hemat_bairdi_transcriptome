...
file_start <- paste0("../output/WGCNA_output/hemat_transcriptomev1.6/all_crabs_no_filter/", variable, "_as_var/")
...
I chose to use a signed network, since that's generally recommended over unsigned. Therefore, the WGCNA FAQ recommends choosing a soft-thresholding power of 16, since we have between 20 and 30 samples total.
