...
Note the additional column compared to previous runs - since we are including crabs D and F, which are uninfected according to cPCR, infection status is now an included variable
