...
I chose to use an unsigned network, since the direction of correlation could be quite interesting. Therefore, the WGCNA FAQ recommends choosing a soft-thresholding power of 8, since we have between 20 and 30 total samples.
