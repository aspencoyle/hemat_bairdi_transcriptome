...
clusts <- list(c("LTH", "LHL", "HTL", "HTL2", "LTH2", "HLH"),     # Crab A          
               c("LTH", "LHL", "LTH2", "HLH", "LHL2", "HTL", "HTL2"),  # Crab B
               c("LTH", "HLH", "HTL", "LHL", "HTL2", "HTL3", "LHL2"),  # Crab C
               c("LTH", "LTH2", "HLH", "HTL", "HTL2", "LHL", "HLH2"),  # Crab E
               c("LH", "HL", "HL2", "LH2", "MIX", "MIX2"),  # Crab G
               c("HH", "HL", "LH", "HL2", "MIX", "MIX2"),  # Crab H
               c("LH", "HL", "LH2", "HL2", "MIX"))  # Crab I
