...
NOTE: For this one, we are dropping genes without 10+ counts across all samples - for cbai_v4.0 and hemat_v1.6, we dropped all without 5+ counts across all samples. This is because Crab D has 77,300 genes with >5 counts, which is higher than the hclust() bar of 65,536
...
for (i in 1:length(crabs)) {
  ...
  # Drop genes without 10 counts across all 3 samples
  keep <- rowSums(crabdat) >= 10
