...
Inputs are libraries pseudoaligned (with kallisto) with cbai_transcriptomev2.0 (AKA cbaihemat_transcriptomev2.0), which is not filtered by taxa.
...
Each crab will be clustered  over time. These will be given one of four assignments based on their expression patterns. Multiple clusters may be given the same assignment.
...
Crabs with only two time points (crabs G, H, and I) will be clustered as well. For these, four assignments will be given. Again, multiple clusters may be given the same assignment.
...
clusts <- list(c("LLH", "MHL", "HML", "LMH", "HLM"),     # Crab A          
               c("TEST", "TEST2", "TEST3", "TEST4", "TEST5"),  # Crab B
               c("TEST", "TEST2", "TEST3", "TEST4", "TEST5"),  # Crab C
               c("TEST", "TEST2", "TEST3", "TEST4", "TEST5"),  # Crab E
               c("TEST", "TEST2", "TEST3", "TEST4", "TEST5"),  # Crab G
               c("TEST", "TEST2", "TEST3", "TEST4", "TEST5"),  # Crab H
               c("TEST", "TEST2", "TEST3", "TEST4", "TEST5"))  # Crab I
