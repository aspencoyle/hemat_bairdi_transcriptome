...
Each crab will be clustered into 5 clusters over time. These will be given one of five assignments based on their expression patterns

- HTL = high to low (pattern starts high, ends low)

- LTH = low to high (pattern starts low, ends high)
