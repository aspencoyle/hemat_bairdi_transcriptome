...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. Here, that means we will choose a soft-thresholding power of:
- 5: Day, Infection, Hemat_Level, SC
- 6: Temperature
- 9: CW
