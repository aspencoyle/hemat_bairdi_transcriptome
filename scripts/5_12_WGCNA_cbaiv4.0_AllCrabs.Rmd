...
crabTraits <- data.frame("crab" = binarizeCategoricalVariable(x = c(rep(c("A", "B", "C", "D", "E", "F", "G", "H", "I"), times = 2), 
                         ...
                         "infection" = c(rep(c(rep("Infected", times = 3),
                                         ...
                                         "Uninfected", "Infected", "Uninfected"),
                         "hemat_level" = scale(c(rep(c(1117, 158230, 333000,
                                                       380503, 1550, 4586,
...
Typically, we would choose the lowest power below 15 that reached an R2 value of 0.8 or higher. Here, that means we will choose a soft-thresholding power of 9 for all runs
