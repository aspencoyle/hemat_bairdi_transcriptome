...
[TK: Run analysis on Amb Day 0-17 to look at progression of]
...
```{r, fig.cap = "Module enrichment for ambient-temperature libraries, Days 0-2 (unfiltered transcriptome)", echo = FALSE}
